 ...
 */
package top.jessi.okgo.adapter;

import top.jessi.okgo.cache.CacheEntity;
import top.jessi.okgo.cache.policy.CachePolicy;
import top.jessi.okgo.cache.policy.DefaultCachePolicy;
import top.jessi.okgo.cache.policy.FirstCacheRequestPolicy;
import top.jessi.okgo.cache.policy.NoCachePolicy;
import top.jessi.okgo.cache.policy.NoneCacheRequestPolicy;
import top.jessi.okgo.cache.policy.RequestFailedCachePolicy;
