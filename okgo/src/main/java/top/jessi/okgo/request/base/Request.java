 ...
 */
package top.jessi.okgo.request.base;
...
import top.jessi.okgo.adapter.AdapterParam;
import top.jessi.okgo.adapter.CacheCall;
import top.jessi.okgo.adapter.Call;
import top.jessi.okgo.adapter.CallAdapter;
import top.jessi.okgo.cache.CacheEntity;
import top.jessi.okgo.cache.CacheMode;
import top.jessi.okgo.cache.policy.CachePolicy;
import top.jessi.okgo.callback.Callback;
import top.jessi.okgo.convert.Converter;
import top.jessi.okgo.model.HttpHeaders;
import top.jessi.okgo.model.HttpMethod;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = OK.getInstance().getOkHttpClient();
